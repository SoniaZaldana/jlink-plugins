...
/**
 * Plugin for ServiceLoader analysis.
 */
public class ServiceLoaderConstantPropagator extends AbstractPlugin {

    public static final String NAME = "const-prop";
    ...
    public ServiceLoaderConstantPropagator() {
        super(NAME);
        try {
